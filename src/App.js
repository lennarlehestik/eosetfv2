              ...
              <div class="rightbar">
                ...
                <div class="colorcreatecard">
                  <div class="promotext">
                    ...
                    <b>{historicalprices ? historicalprices[periodbutton] : <CircularProgress style={{'color': '#5A83F1'}} size="14.4px"/>}{" "}
                    EOS</b>
                  </div>
                    ...
                    <div class="invest">
                        ...
                        InputProps={{
                          endAdornment: (
                            <InputAdornment position="end">
                              ...
                              " USD"
                              :
                              <CircularProgress style={{'color': '#5A83F1'}} size="16px"/>
                              }
                            </InputAdornment>
                          ),
                          startAdornment: (
                      ...
                      >
                        ...
                        <b>
                          ...
                          :
                          <CircularProgress style={{'color': '#5A83F1'}} size="13px" />
                          }
                        </b>
                      </div>
                      <button
